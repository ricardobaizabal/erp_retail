...
Partial Public Class SalesInvoicePDF
    ...
    Private Sub Factura_NeedDataSource(sender As Object, e As EventArgs) Handles Me.NeedDataSource
        Dim cotizacionID As Long = Me.ReportParameters("pedidoId").Value
        Dim ds As DataSet = New DataSet
        Try
            ds = FillDataSet("EXEC pPedidos @cmd=33, @pedidoid='" & cotizacionID.ToString & "'")
