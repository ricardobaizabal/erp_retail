<%@ Page Title="" Language="VB" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" AutoEventWireup="false" CodeBehind="DetalleVentaTipoPago.aspx.vb" Inherits="LinkiumCFDI.DetalleVentaTipoPago" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br />
        ...
        <fieldset>
            ...
            <br />
            <span class="item">
                <%--Familia: <asp:DropDownList  ID="cmbfamilia" Skin="Silk" runat="server"  AutoPostBack="true"></asp:DropDownList>    
                Sub-Familia: <asp:DropDownList  ID="cmbsubfamilia" Skin="Silk" runat="server"  AutoPostBack="false"></asp:DropDownList>--%>    
                
                Desde el:<telerik:RadDatePicker ID="fechaini" Runat="server" Skin="Web20">
               ...
               hasta el: <telerik:RadDatePicker ID="fechafin" Runat="server" Skin="Web20">
                                        <Calendar Skin="Web20" UseColumnHeadersAsSelectors="False" 
                                            UseRowHeadersAsSelectors="False" ViewSelectorText="x">
                                        </Calendar>
                                        <DatePopupButton HoverImageUrl="" ImageUrl="" />
        ...
        <fieldset>
            <legend style="padding-right: 6px; color: Black">
                <asp:Image ID="Image2" runat="server" ImageUrl="~/images/icons/ListaProveedores_03.jpg" ImageAlign="AbsMiddle" />&nbsp;<asp:Label ID="lblProvidersListLegend" runat="server" Text="Listado Acumulado por Tipo de Pago" Font-Bold="true" CssClass="item"></asp:Label>
            </legend>
                ...
                <tr>
                    <td style="height: 5px" colspan="2">
                        <telerik:RadGrid ID="pedidosList" runat="server" AllowPaging="true"
                            ...
                            <ExportSettings IgnorePaging="True" FileName="TotalPedidos">
                                <Excel Format="Biff" />
                            </ExportSettings>
                            
                            <MasterTableView AllowMultiColumnSorting="False" DataKeyNames="nombre" Name="Pedidos" NoMasterRecordsText="No se encontraron registros para mostrar" Width="100%" CommandItemDisplay="Top">
                            <CommandItemSettings ShowAddNewRecordButton="false" ShowExportToExcelButton="true" ShowExportToPdfButton="false" ExportToPdfText="exportar a pdf" ExportToExcelText="exportat a excel"></CommandItemSettings>
                                <Columns>
                                    ...
                                    <%--<telerik:GridTemplateColumn AllowFiltering="true" HeaderText="Folio" UniqueName="id">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%# Eval("codigo") %>' CommandName="cmdEdit" Text='<%# Eval("id") %>' CausesValidation="false"></asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    </telerik:GridTemplateColumn>--%>
                                     <telerik:GridBoundColumn DataField="Nombre" HeaderText="Sucursal" UniqueName="Nombre" >
                                    </telerik:GridBoundColumn>
                                    
                                    <telerik:GridBoundColumn DataField="Efectivo" HeaderText="Efectivo" UniqueName="Efectivo"  DataFormatString="{0:C0}" FooterStyle-HorizontalAlign = "Right" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" Aggregate="Sum">
                                    </telerik:GridBoundColumn>
                                    
                                    <telerik:GridBoundColumn DataField="TarjetaCredito" HeaderText="Tarjeta de Credito" UniqueName="Efectivo"  DataFormatString="{0:C0}" FooterStyle-HorizontalAlign = "Right" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" Aggregate="Sum">
                                    </telerik:GridBoundColumn>
                                    
                                    <telerik:GridBoundColumn DataField="Deposito" HeaderText="Deposito" UniqueName="Deposito"  DataFormatString="{0:C0}" FooterStyle-HorizontalAlign = "Right" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" Aggregate="Sum">
                                    </telerik:GridBoundColumn>
                                    
                                    <telerik:GridBoundColumn DataField="Cheque" HeaderText="Cheque" UniqueName="Cheque"  DataFormatString="{0:C0}" FooterStyle-HorizontalAlign = "Right" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" Aggregate="Sum">
                                    </telerik:GridBoundColumn>
                                    
                                    <telerik:GridBoundColumn DataField="Transferencia" HeaderText="Transferencia" UniqueName="Transferencia"  DataFormatString="{0:C0}" FooterStyle-HorizontalAlign = "Right" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" Aggregate="Sum">
                                    </telerik:GridBoundColumn>
