<%@ Page Title="" Language="VB" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" AutoEventWireup="false" CodeBehind="DetalleVenta.aspx.vb" Inherits="LinkiumCFDI.DetalleVenta" %>
                ...
                <tr>
                    <td style="height: 5px" colspan="2">
                        <telerik:RadGrid ID="pedidosList" runat="server" AllowPaging="true"
                            ...
                            <MasterTableView AllowMultiColumnSorting="False" DataKeyNames="Folio" Name="Pedidos" NoMasterRecordsText="No se encontraron registros para mostrar" Width="100%" CommandItemDisplay="Top">
                            <CommandItemSettings ShowAddNewRecordButton="false" ShowExportToExcelButton="true" ShowExportToPdfButton="false" ExportToPdfText="exportar a pdf" ExportToExcelText="exportat a excel"></CommandItemSettings>
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="Matricula" HeaderText="Matricula" UniqueName="familia">
                                    </telerik:GridBoundColumn>
                                    
                                    <telerik:GridBoundColumn DataField="Alumno" HeaderText="Alumno" UniqueName="Alumno">
                                    </telerik:GridBoundColumn>
                                    
                                    <telerik:GridBoundColumn DataField="Monto" HeaderText="Total" UniqueName="monto" DataFormatString="{0:C2}" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign = "Right" Aggregate="Sum">
                                    </telerik:GridBoundColumn>
                                    
                                    <telerik:GridBoundColumn DataField="Cobro" HeaderText="Cobro" UniqueName="Cobro" DataFormatString="{0:C2}" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign = "Right" Aggregate="Sum">
                                    </telerik:GridBoundColumn>
                                    
                                    <telerik:GridBoundColumn DataField="Saldo" HeaderText="Saldo" UniqueName="saldo" DataFormatString="{0:C2}" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign = "Right" Aggregate="Sum">
                                    </telerik:GridBoundColumn>
                                   
                                    
                                    
                                    
                                    <telerik:GridBoundColumn DataField="F_Alta" HeaderText="F. Alta" UniqueName="falta" 
                                    >
                                    </telerik:GridBoundColumn>
