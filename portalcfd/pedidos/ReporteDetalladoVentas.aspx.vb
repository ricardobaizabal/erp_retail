...
Public Class ReporteDetalladoVentas
    ...
    Function ObtenerPedidos() As DataSet
        ...
        Dim sql As String = "EXEC pReporteVentasDetalle @fechaini='" & fechaini.SelectedDate.Value.ToShortDateString & "', @fechafin='" & fechafin.SelectedDate.Value.ToShortDateString & "', @familia='" & cmbfamilia.SelectedValue & "', @subfamilia='" & cmbsubfamilia.SelectedValue & "', @sucursalid='" & cmbsucursal.SelectedValue & "'"
