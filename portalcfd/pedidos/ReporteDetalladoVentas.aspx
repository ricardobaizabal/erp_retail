<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" CodeBehind="ReporteDetalladoVentas.aspx.vb" Inherits="LinkiumCFDI.ReporteDetalladoVentas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset>
        ...
        <table width="100%" border="0">
            <tr>
                <td style="width: 8%;" class="item">Familia:</td>
                <td style="width: 20%;">
                    <asp:DropDownList ID="cmbfamilia" Skin="Office2007" runat="server" Width="98%" AutoPostBack="true"></asp:DropDownList>
                </td>
                <td style="width: 10%;" class="item">Sub-Familia:</td>
                <td style="width: 20%;">
                    <asp:DropDownList ID="cmbsubfamilia" Skin="Office2007" runat="server" Width="98%" AutoPostBack="false"></asp:DropDownList>
                </td>
                <td style="width: 10%;" class="item">Sucursal:</td>
                <td style="width: 15%;">
                    <asp:DropDownList ID="cmbsucursal" Skin="Office2007" runat="server" Width="98%" AutoPostBack="false"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td style="width: 8%;" class="item">Desde:</td>
                <td style="width: 20%;">
                ...
                <td style="width: 8%;" class="item">Hasta:</td>
                <td style="width: 20%;">
    ...
    <fieldset>
        <legend style="padding-right: 6px; color: Black">
            <asp:Image ID="Image2" runat="server" ImageUrl="~/images/icons/ListaProveedores_03.jpg" ImageAlign="AbsMiddle" />&nbsp;<asp:Label ID="lblProvidersListLegend" runat="server" Text="Reporte Detallado de Ventas" Font-Bold="true" CssClass="item"></asp:Label>
        </legend>
        <table width="100%" border="0">
            <tr>
                <td style="height: 5px" colspan="2">
                    <telerik:RadGrid ID="pedidosList" runat="server" AllowPaging="false"
                        ...
                        <MasterTableView AllowMultiColumnSorting="False" DataKeyNames="codigo" Name="Pedidos" NoMasterRecordsText="No se encontraron registros para mostrar" Width="100%" CommandItemDisplay="Top">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="Sub" HeaderText="Sub-Familia" UniqueName="sub">
                                </telerik:GridBoundColumn>

                                <telerik:GridBoundColumn DataField="Producto" HeaderText="Producto" UniqueName="Producto">
                                </telerik:GridBoundColumn>

                                <telerik:GridBoundColumn DataField="costo" HeaderText="Costo Unitario" UniqueName="costo" DataFormatString="{0:C2}" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right">
                                </telerik:GridBoundColumn>

                                <telerik:GridBoundColumn DataField="Cantidad" HeaderText="Cantidad" UniqueName="Cantidad" DataFormatString="{0:N0}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" FooterStyle-Font-Bold="true" Aggregate="Sum">
                                </telerik:GridBoundColumn>

                                <telerik:GridBoundColumn DataField="Total" HeaderText="Total" UniqueName="Total" DataFormatString="{0:C2}" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" FooterStyle-Font-Bold="true" Aggregate="Sum">
                                </telerik:GridBoundColumn>
