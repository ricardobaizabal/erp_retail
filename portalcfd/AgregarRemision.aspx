        ...
        <fieldset style="padding: 10px;">
            ...
            <table border="0" cellpadding="3" cellspacing="3" align="left" width="100%">
                ...
                <tr>
                    ...
                    <td width="25%" class="item">
                        <asp:Label ID="lblTipoRelacion" runat="server" Text="Tipo de Relación:" CssClass="item" Font-Bold="True" Visible="false"></asp:Label>
                    </td>
                    <td width="25%" class="item">
                        <asp:Label ID="lblUUID" runat="server" Text="UUID:" CssClass="item" Font-Bold="True"  Visible="false"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td width="25%" class="item">
