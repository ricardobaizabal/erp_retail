...
#Region "Load Initial Values"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ObjCat.Catalogo(cmbMetodoPago, "select codigo, descripcion from tblc_MetodoPago order by codigo desc", 0)
            cmbMetodoPago.SelectedValue = "PUE"
    ...
    Private Function GeneraPDF(ByVal cfdid As Long) As Telerik.Reporting.Report
        ...
        Select Case tipoid
            Case 3, 6, 7      ' honorarios y arrendamiento
                Dim reporte As New FormatosPDF.formato_cfdi_honorarios33
                ...
                Return reporte
            Case Else
                Dim reporte As New FormatosPDF.formato_cfdi33
                reporte.ReportParameters("plantillaId").Value = plantillaid
                reporte.ReportParameters("cfdiId").Value = cfdid
                Select Case tipoid
                    Case 1, 4, 7
