<%@ Page Title="" Language="VB" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" AutoEventWireup="false" CodeBehind="CiclosEscolares.aspx.vb" Inherits="LinkiumCFDI.CiclosEscolares" %>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1">
        ...
        <fieldset>
            <legend style="padding-right: 6px; color: Black">
                 <asp:Image ID="Image2" runat="server" ImageUrl="~/images/icons/ListaProveedores_03.jpg" ImageAlign="AbsMiddle" />&nbsp;<asp:Label ID="lblUsersListLegend" runat="server" Font-Bold="true" CssClass="item">Listado de ciclos escolares</asp:Label>
            </legend>
            <table width="50%" border="0">
                <tr>
                    <td style="height: 5px">
                        <telerik:RadGrid ID="CiclosEscolaresList" runat="server" AllowPaging="True"
                            AutoGenerateColumns="False" GridLines="None" PageSize="15" ShowStatusBar="True"
                            Skin="Office2007" Width="100%">
                            <PagerStyle Mode="NumericPages" />
                            <MasterTableView AllowMultiColumnSorting="False" DataKeyNames="id" Name="CicloEscolar" Width="100%">
                                <Columns>
                                    <telerik:GridBoundColumn DataField="id" HeaderText="Folio" HeaderStyle-Font-Bold="true" UniqueName="id">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridTemplateColumn AllowFiltering="true" HeaderText="Ciclo escolar" HeaderStyle-Font-Bold="true" UniqueName="nombre">
                                        <ItemTemplate>
                ...
                <tr>
                    <td align="right" style="height: 5px">
                        <asp:Button ID="btnAgregar" runat="server" Text="Agregar ciclo escolar" CausesValidation="False" CssClass="item" />
                    </td>
                </tr>
                <tr>
        ...
        <asp:Panel ID="panelRegistration" runat="server" Visible="False">
            <fieldset>
                ...
                <table width="100%" border="0">
                    <tr>
                        <td style="width:50%;">
                            <asp:Label ID="lblNombre" runat="server" CssClass="item" Text="Ciclo escolar:" Font-Bold="True"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:HiddenField ID="CicloID" runat="server" Value="0" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan=2>&nbsp;</td>
