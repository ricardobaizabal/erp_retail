                    ...
                    <telerik:RadGrid ID="facturaslist" runat="server" AllowPaging="True" AllowSorting="True"
                        ...
                        <MasterTableView AllowMultiColumnSorting="False" DataKeyNames="id" Name="CuentasPorPagar" Width="100%" NoMasterRecordsText="No existen registros en ese rango de fechas." CommandItemDisplay="Top">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="fecha_promesa_pago" HeaderText="Fec. Promesa de Pago" DataFormatString="{0:d}" UniqueName="fecha_promesa_pago" AllowFiltering="false">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="fecha_pago" HeaderText="Fec. Pago" DataFormatString="{0:d}" UniqueName="fecha_pago" AllowFiltering="false">
                                </telerik:GridBoundColumn>
