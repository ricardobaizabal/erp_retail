...
Partial Public Class cuentas_por_pagar
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            anioid.SelectedValue = Date.Now.Year
            mesid.SelectedValue = Date.Now.Month
    ...
    Private Sub MuestraLista()
        ...
        '
        Dim ObjData As New DataControl
        ds = ObjData.FillDataSet("exec pCuentasPorPagar @cmd=1, @anio='" & anioid.SelectedValue.ToString & "', @mes='" & mesid.SelectedValue.ToString & "', @proveedorid='" & proveedorid.SelectedValue.ToString & "'")
