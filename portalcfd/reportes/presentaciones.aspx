<%@ Page Title="" Language="vb" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" AutoEventWireup="false" CodeBehind="presentaciones.aspx.vb" Inherits="LinkiumCFDI.presentaciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1" ClientEvents-OnRequestStart="OnRequestStart">
        ...
        <fieldset>
            <legend style="padding-right: 6px; color: Black">
                <asp:Label ID="Label1" runat="server" Text="Venta total por presentaciones" Font-Bold="true" CssClass="item"></asp:Label>
            </legend>
            <table width="100%">
                <tr>
                ...
                <tr>
                    <td class="item">
                        <telerik:RadHtmlChart runat="server" ID="RadVentasPorFamilia" Width="700px" Height="500px">
                            <PlotArea>
                                <Series>
                                    <telerik:PieSeries DataFieldY="Total" NameField="Presentacion" ExplodeField="IsExploded">
                                        <LabelsAppearance DataFormatString="{0:C}">
                                        </LabelsAppearance>
                                        <TooltipsAppearance>
                                            <ClientTemplate>
                                                #=dataItem.Presentacion#
                                            </ClientTemplate>
                                        </TooltipsAppearance>
