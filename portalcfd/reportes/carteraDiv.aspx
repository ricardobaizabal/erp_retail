<%@ Page Title="" Language="VB" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" AutoEventWireup="false" Inherits="LinkiumCFDI.portalcfd_reportes_carteraDiv" Codebehind="carteraDiv.aspx.vb" %>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1">
        ...
        <fieldset>
            ...
            <table width="100%">
                ...
                <tr>
                    <td class="item">
                        Seleccione el cliente que desee consultar:<br /><br />
                        <table>
                            <tr>
                                <td>
