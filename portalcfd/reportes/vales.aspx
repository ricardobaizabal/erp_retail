<%@ Page Title="" Language="VB" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" CodeBehind="vales.aspx.vb" Inherits="LinkiumCFDI.vales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script language="javascript" type="text/javascript">
        function OnRequestStart(target, arguments) {
            if ((arguments.get_eventTarget().indexOf("valesList") > -1)) {
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" SkinID="Office2007" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1" ClientEvents-OnRequestStart="OnRequestStart">
        <fieldset style="min-height: 400px;">
            <legend style="padding-right: 6px; color: Black">
                <asp:Label ID="lblListTitle" runat="server" Font-Bold="true" CssClass="item" Text="Vales de Caja"></asp:Label>
            </legend>
            <br />
            <table>
                <tr>
                ...
                <tr>
                    <td colspan="7">
                        <telerik:RadGrid ID="valesList" runat="server" Width="100%" ShowStatusBar="True" ShowFooter="true" ExportSettings-ExportOnlyData="true"
                            AutoGenerateColumns="False" AllowPaging="True" PageSize="50" GridLines="None" Skin="Office2007">
                            <PagerStyle Mode="NumericPages"></PagerStyle>
                            <ExportSettings IgnorePaging="True" FileName="ValesCaja">
                                <Excel Format="ExcelML" />
                            </ExportSettings>
                            <MasterTableView Width="100%" DataKeyNames="id" Name="Vales" NoMasterRecordsText="No se encontraron registros." AllowMultiColumnSorting="False" CommandItemDisplay="Top">
                                ...
                                <Columns>
                                    <telerik:GridBoundColumn DataField="id" HeaderText="No. Vale" UniqueName="id">
