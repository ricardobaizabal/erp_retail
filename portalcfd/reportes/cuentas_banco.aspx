    ...
    <asp:Panel ID="panelRegistroCuenta" runat="server" Visible="False">
        <fieldset>
            ...
            <table width="100%" border="0">
                ...
                <tr valign="top">
                    <td width="25%">
                        <asp:DropDownList ID="bancoid" runat="server" Width="50%" CssClass="box"></asp:DropDownList>
                    ...
                    <td width="25%">
                        <asp:TextBox ID="txtCuenta" CssClass="item" Width="200px" runat="server"></asp:TextBox>
