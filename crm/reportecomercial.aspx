<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" CodeBehind="reportecomercial.aspx.vb" Inherits="LinkiumCFDI.reportecomercial" %>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" LoadingPanelID="RadAjaxLoadingPanel1">
        ...
        <fieldset>
            ...
            <table width="100%">
                ...
                <tr>
                    <td>
                        <telerik:RadGrid ID="oportunidadeslist" runat="server" Width="100%" ShowStatusBar="true"
                            ...
                            <MasterTableView Width="100%" DataKeyNames="id" Name="Vacantes" AllowMultiColumnSorting="false" AllowSorting="true" HeaderStyle-Font-Underline="false">
                                <Columns>
                                   ...
                                   <telerik:GridBoundColumn DataField="tiposervicio" HeaderText="Tipo Serv." UniqueName="tiposervicio">
                                    ...
                                    <telerik:GridBoundColumn DataField="probabilidad" HeaderText="Probabilidad de venta" UniqueName="probabilidad">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="fecha_cierre" HeaderText="Fecha Cierre" UniqueName="fecha_cierra" DataFormatString="{0:dd/MM/yyyy}">
                                    </telerik:GridBoundColumn>
